...
\parUna técinca muy popular y relativamente sencilla de entender el agarrar el primer, último y elemento de el medio del arreglo o partición, 
...
\section{Apéndice}
A continuación se anexan los códigos en C\# de implementaciones y el de python para generar los gráficos.
\subsection{Implementaciones C\#}
\begin{minted}{csharp}
Código
\end{minted}
\subsection{Gráficos}
